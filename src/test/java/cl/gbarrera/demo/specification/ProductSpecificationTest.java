...
class ProductSpecificationTest {
  ...
  void byCriteria_shouldCoverNameCondition_whenNameIsSet() {
    ...
    when(builder.greaterThanOrEqualTo((Expression<Long>) any(Expression.class), (Long) anyLong()))
        .thenReturn(minPricePredicate);

    when(builder.lessThanOrEqualTo((Expression<Long>) any(Expression.class), (Long) anyLong()))
  ...
  void constructor_shouldBePrivate() throws Exception {
    Constructor<ProductSpecification> constructor =
        ProductSpecification.class.getDeclaredConstructor();
